  ...
  return (
    <div className="min-h-screen bg-[#fbfaf8]">
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-4 py-6">
                <div className="flex justify-end items-start gap-3 mb-6"><div className="flex gap-2 shrink-0"><Link href="/lots/new" className="inline-flex h- items-center justify-center px-4 rounded-full bg-black text-white text- font-medium">+ New lot</Link><button onClick={()=>setShowRoomModal(true)} className="inline-flex h- items-center justify-center px-4 rounded-full bg-white border border-zinc-200 text- font-medium">+ Buyer room</button></div></div>
